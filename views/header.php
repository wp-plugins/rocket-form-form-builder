      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo admin_url().'?page=rocket-forms&mod=formbuilder&controller=forms&action=create_uiform';?>"><?php echo __('New','FRocket_admin'); ?></a></li>
            <li><a href="#"><?php echo __('Save','FRocket_admin'); ?></a></li>
            <li class="divider"></li>
            <li><a href="<?php echo admin_url().'?page=rocket-forms&mod=formbuilder&controller=forms&action=list_uiforms';?>"><?php echo __('List forms','FRocket_admin'); ?></a></li>
          </ul>
        </li>
        <?php if(isset($_GET['action']) && (string)$_GET['action']==='create_uiform'){?>
        <li class="divider-menu"></li>
        <li class="dropdown">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo admin_url().'?page=rocket-forms&mod=formbuilder&controller=records&action=list_records';?>">
                <?php echo __('List all Forms','FRocket_admin'); ?>
                </a>
            </li>
            <li><a href="<?php echo admin_url().'?page=rocket-forms&mod=formbuilder&controller=records&action=info_records_byforms';?>">
                <?php echo __('List by Form','FRocket_admin'); ?></a>
            </li>
            <li><a href="<?php echo admin_url().'?page=rocket-forms&mod=formbuilder&controller=records&action=custom_report';?>">
        ...
        <li class="divider-menu"></li>
        <li >
            <a href="<?php echo admin_url().'?page=rocket-forms&mod=formbuilder&controller=forms&action=create_uiform&opt=import';?>">
                <i class="fa fa-reply"></i> <?php echo __('Import','FRocket_admin'); ?></a></li>
        <li class="divider-menu"></li>
        <li ><a href="<?php echo admin_url().'?page=rocket-forms&mod=formbuilder&controller=forms&action=export_form';?>">
            <i class="fa fa-share"></i> <?php echo __('Export','FRocket_admin'); ?></a></li>
        <li class="divider-menu"></li>
        <li ><a href="<?php echo admin_url().'?page=rocket-forms&mod=formbuilder&controller=records&action=view_charts';?>">
            <span class="fa fa-area-chart"></span> <?php echo __('Charts','FRocket_admin'); ?> 
            </a>
        </li>
        <li class="divider-menu"></li>
        <li ><a href="<?php echo admin_url().'?page=rocket-forms&mod=formbuilder&controller=settings&action=view_settings';?>">
        ...
        <li class="divider-menu"></li>
        <li ><a href="http://codecanyon.net/item/rocket-form-wordpress-form-builder/11057544?ref=Softdiscover" class="rkfm-express-pro-button" target="_blank">
