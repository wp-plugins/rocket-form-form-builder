...
if (!class_exists('RocketForm_Express')) {

    final class RocketForm_Express {
        ...
        */
        private function check_requirements() {
            ...
            if (is_plugin_active( 'rocket-forms/rocket-forms.php' ) ) {
               return false;
            }
            return true;
        }
        ...
        private function define_constants() {
            ...
            $this->define('UIFORM_FORMS_URL', plugins_url().'/'.basename(dirname(__FILE__)));
...
function wpRFRM_Express() {
    return RocketForm_Express::instance();
}
