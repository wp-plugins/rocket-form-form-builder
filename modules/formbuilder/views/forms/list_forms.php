            ...
            <div class="widget-body">
                <div id="uiform-listform-options">
                    <div class="uiform-listform-options-col">
                       ...
                       href="<?php echo admin_url().'?page=rocket-forms&mod=formbuilder&controller=forms&action=create_uiform';?>">
                        <i class="fa fa-plus">
                        </i>
...
<?php foreach ($query as $row): ?>
                        <tr>
                            ...
                            <td>
                             <code> [rocketform id="<?php echo $row->fmb_id;?>"]</code>
                            </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <li><a 
                                            ...
                                            href="<?php echo admin_url().'?page=rocket-forms&mod=formbuilder&controller=forms&action=create_uiform&form_id='.$row->fmb_id;?>">
