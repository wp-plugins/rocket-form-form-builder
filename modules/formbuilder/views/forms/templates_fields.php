...
<div id="uiform-fields-templates" style="display:none;">
    ...
    <div id="" data-typefield="1" data-iscontainer="1" class="uiform-gridsytem-table uiform-gridsystem-one uiform-field">
        <div class="uiform-field-wrap uiform-field-move">
            ...
            <div class="uiform-field-move-box2-inner">
    ...
    <!--\ Standard Fields -->
    <!--\ textbox -->
        <div id=""  data-typefield="6" class="uiform-textbox uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                ...
                <div class="uiform-field-move-box-inner">
                    <i class="fa fa-arrows"></i>
                </div>
            </div>
        </div>
    <!--\ Textarea -->
        <div id=""  data-typefield="7" class="uiform-textarea uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!--\ radio button -->
        <div id=""  data-typefield="8" class="uiform-radiobtn uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!-- checkbox -->
     <div id=""  data-typefield="9" class="uiform-checkbox uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!-- select -->
     <div id=""  data-typefield="10" class="uiform-select uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!-- multiselect -->
     <div id=""  data-typefield="11" class="uiform-multiselect uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!-- File upload -->
     <div id=""  data-typefield="12" class="uiform-fileupload uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!-- Image upload -->
     <div id=""  data-typefield="13" class="uiform-imageupload uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!-- Custom html -->
     <div id=""  data-typefield="14" class="uiform-customhtml uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
      ...
      <!-- Password -->
     <div id=""  data-typefield="15" class="uiform-password uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!-- Prepended text -->
     <div id=""  data-typefield="28" class="uiform-preptext uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!-- Appended text -->
     <div id=""  data-typefield="29" class="uiform-appetext uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <div id=""  data-typefield="30" class="uiform-prepapptext uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!-- slider -->
     <div id=""  data-typefield="16" class="uiform-slider uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!-- range -->
     <div id=""  data-typefield="17" class="uiform-range uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
     ...
     <!-- spinner -->
     <div id=""  data-typefield="18" class="uiform-spinner uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
  ...
  <!-- Date picker -->
     <div id=""  data-typefield="24" class="uiform-datepicker uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
  ...
  <!-- Time picker -->
     <div id=""  data-typefield="25" class="uiform-timepicker uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
   ...
   <!-- Date Time picker -->
     <div id=""  data-typefield="26" class="uiform-datetime uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
   ...
   <!-- Submit button -->
     <div id=""  data-typefield="20" class="uiform-submitbtn uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
   ...
   <!-- hidden input -->
     <div id=""  data-typefield="21" class="uiform-hiddeninput uiform-field  uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
    ...
    <!-- Star rating -->
     <div id=""  data-typefield="22" class="uiform-ratingstar uiform-field  uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
    ...
    <!-- Color picker -->
     <div id=""  data-typefield="23" class="uiform-colorpicker uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2">
                        <div class="uifm-control-label">
    ...
    <!-- Divider -->
     <div id=""  data-typefield="32" class="uiform-divider uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-12">
   ...
   <!-- heading 1 -->
     <div id=""  data-typefield="33" class="uiform-heading1 uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2" style="display: none;">
                        <div class="uifm-control-label">
     ...
     <!-- heading 2 -->
     <div id=""  data-typefield="34" class="uiform-heading2 uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2" style="display: none;">
                        <div class="uifm-control-label">
     ...
     <div id=""  data-typefield="35" class="uiform-heading3 uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2" style="display: none;">
                        <div class="uifm-control-label">
     ...
     <div id=""  data-typefield="36" class="uiform-heading4 uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2" style="display: none;">
                        <div class="uifm-control-label">
     ...
     <div id=""  data-typefield="37" class="uiform-heading5 uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2" style="display: none;">
                        <div class="uifm-control-label">
     ...
     <div id=""  data-typefield="38" class="uiform-heading6 uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-2" style="display: none;">
                        <div class="uifm-control-label">
   ...
   <!-- wizard button -->
     <div id=""  data-typefield="39" class="uiform-wizardbtn uiform-field uiform-field-move-wrap">
            <div class="uiform-field-wrap uiform-field-move">
                <div class="rkfm-row">
                    <div class="rkfm-col-sm-12">
                        <div class="uifm-input-container">                               
