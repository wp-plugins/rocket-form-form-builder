...
<div class="uiform-set-field-wrap" id="uiform-set-form-skin">
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                    <label ><?php echo __('Custom width','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                    <label ><?php echo __('Custom padding','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span></label>
                    <div class="">
    ...
    <div class="row express-form-background-section">
        <div class="col-md-12">
            <div class="form-group">
                    ...
                    <div class="">
                        ...
                        <div class="col-md-9">
                                        ...
                                        <div class="controls form-group">
                                            <div class="btn-group btn-group-justified"
                                                ...
                                                <label 
                                                    ...
                                                    class="btn btn-warning uifm-fmskin-setoption-btn" >
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                <div class="col-md-4">
                                   <label ><?php echo __('Background image','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right"
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span></label>
                                </div>
    ...
    <div class="row">
     ...
     <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                    <label ><?php echo __('Box Shadow','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span></label>
                    <div class="">
