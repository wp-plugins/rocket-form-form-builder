...
<div class="uiform-set-field-wrap" id="uiform-set-field-lbl-panel">
    ...
    <div class="row">
                ...
                <div class="uifm-fld-val-opts">
                    ...
                    <div class=" btn-group btn-group-justified" data-toggle="buttons">
                            ...
                            <label 
                                ...
                                class="btn btn-primary tooltip-val-demo uifm-f-setoption-gchecks"  >
                        ...
                        <div class=" btn-group btn-group-justified" data-toggle="buttons">
                            ...
                            <label 
                                ...
                                class="btn btn-primary tooltip-val-demo "  >
                                     <?php echo __('Letters','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       ...
                       ><i class="fa fa-lock"></i></span>
                            ...
                            <label 
                                ...
                                data-toggle-disable="btn-primary"
                                data-settings-option="group-checkboxes"
                                class="btn btn-primary uifm-f-setoption-gchecks" >
                                 <?php echo __('Letter & Numbers','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span>
                            </label>
                         ...
                         <div class=" btn-group btn-group-justified" data-toggle="buttons">   
                            <label 
                                ...
                                data-settings-option="group-checkboxes"
                                class="btn btn-primary uifm-f-setoption-gchecks" >
                                  <?php echo __('Only numbers','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span>
                            </label>
                            <label 
                                ...
                                data-settings-option="group-checkboxes"
                                class="btn btn-primary uifm-f-setoption-gchecks" >
                                 <?php echo __('Email','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span>
                            </label>
        ...
        <div class="row" id="uifm-custom-val-title-added" style="display:none;">
            <div class="col-md-12">
    ...
    <div class="row">
            <div class="col-md-6">
               <div class="form-group">
                    <label ><?php echo __('Text Color','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                    ...
                    <div data-field-store="validate-tip_col"
                        ...
                        <input 
                            ...
                            name="uifm_fld_val_tipcolor" class="form-control" />
         ...
         <div class="col-sm-6">
             <div class="form-group">
                    <label ><?php echo __('Background Color','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span></label>
                    <div data-field-store="validate-tip_bg"
                        ...
                        <input 
                            ...
                            name="uifm_fld_val_tipbg" class="form-control" />
    ...
    <div class="row">
            <div class="col-md-4">
               <div class="form-group">
                    <label ><?php echo __('Set required icon','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span></label>
                    <div class="controls form-group">
         ...
         <div class="col-sm-8">
                <div class="form-group">
                    <label ><?php echo __('Choose required icon','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span></label>
                    <div class="controls form-group">
    ...
    <div class="row">
            <div class="col-md-12">
               <div class="form-group">
                    <label ><?php echo __('Required icon position','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span></label>
                    <div class="controls form-group">
