...
class Uiform_InstallDB {
    ...
    public function install(){
        ...
        $sql = "CREATE  TABLE IF NOT EXISTS $this->form_history (
                ...
                `fbh_error` text,
                PRIMARY KEY (`fbh_id`) ,
                INDEX `fk_".$this->form_history."_".$this->form."1_idx` (`form_fmb_id`) ,
                CONSTRAINT `fk_".$this->form_history."_".$this->form."1`
       ...
       $sql="INSERT INTO $this->form_fields_type VALUES 
        ...
        KEY `fk_".$this->form_fields."_".$this->form_fields_type."1_idx` (`type_fby_id`),
        KEY `fk_".$this->form_fields."_".$this->form."1_idx` (`form_fmb_id`),
        CONSTRAINT `fk_".$this->form_fields."_".$this->form_fields_type."1`
                FOREIGN KEY (`type_fby_id`) 
                REFERENCES `".$this->form_fields_type."` (`fby_id`) 
                ON DELETE NO ACTION 
                ON UPDATE NO ACTION,
        CONSTRAINT `fk_".$this->form_fields."_".$this->form."1` 
                FOREIGN KEY (`form_fmb_id`) 
                REFERENCES `".$this->form."` (`fmb_id`) 
                ON DELETE NO ACTION 
                ON UPDATE NO ACTION
